...
class CourtsControllerTest < ActionController::TestCase
  ...
  test "should create court" do
    assert_difference('Court.count') do
      post :create, court: { latitude: @court.latitude, location: @court.location, longitude: @court.longitude, name: @court.name }
    end
  ...
  test "should update court" do
    put :update, id: @court, court: { latitude: @court.latitude, location: @court.location, longitude: @court.longitude, name: @court.name }
    assert_redirected_to court_path(assigns(:court))
  end
